...
class ChooseRounds:
    ...
    def __init__(self, choose_instructions):
        button_fg = "#FFFFFF"
        button_font = ("Arial", "13", "bold")

        # Set up GUI frame
        self.intro_frame = Frame(padx=10, pady=10)
        self.imtro_frame.grid()
    ...
    class Play:
        def __init(self, how_many):
            ...
            self.rounds_heading = Label(self.quest_frame,
                                        text=rounds_heading,
                                        font=("Arial", "16", "bold")
                                        )
            ...
            self.start_over_button.grid(self.control_frame,
                                        text="Start Over",
